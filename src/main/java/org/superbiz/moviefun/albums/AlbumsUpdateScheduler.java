...
public class AlbumsUpdateScheduler {
    ...
    public AlbumsUpdateScheduler(AlbumsUpdater albumsUpdater, ServiceCredentials serviceCredentials, DataSource dataSource) {
        this.albumsUpdater = albumsUpdater;
        //MysqlDataSource dataSource = new MysqlDataSource();
        //dataSource.setUrl(serviceCredentials.getCredential("movies-mysql", "p.mysql", "credentials.url"));
        //dataSource.setUser(serviceCredentials.getCredential("movies-mysql", "p.mysql", "credentials.username"));
